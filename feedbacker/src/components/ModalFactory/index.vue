  ...
  <teleport to="body">
    ...
    >
      <div class="fixed mx-10" :class="state.width" @click.stop>
        <div
          class="flex flex-col overflow-hidden bg-white rounded-lg animate__fadeInDown animate__animated animate__faster"
        >
...
const ModalLogout = defineAsyncComponent(() => import("../ModalLogout"));
